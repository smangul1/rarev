        ...
        if pileupcolumn.n>0:
            ...
            for pileupread in pileupcolumn.pileups:
                if not pileupread.is_del and not pileupread.is_refskip:
                    ...
                    if pileupread.alignment.query_sequence[pileupread.query_position]!=snpDict[pileupcolumn.pos][1]:
                        #print ('\tbase in read %s = %s' % (pileupread.alignment.query_name, pileupread.alignment.query_sequence[pileupread.query_position]))
            ...
            if len(alleleList)>0:
                ...
                #print "WGS,"+str(pileupcolumn.pos)+","+str(dictWES[pileupcolumn.pos])+","+str(snpDict[pileupcolumn.pos][1])+","+str(len(alleleList))+","+str(ALT_count)+","+str(r)

                fileWGS.write("WGS,"+str(pileupcolumn.pos)+","+str(dictWES[pileupcolumn.pos])+","+str(snpDict[pileupcolumn.pos][1])+","+str(len(alleleList))+","+str(ALT_count)+","+str(r))
                fileWGS.write("\n")
